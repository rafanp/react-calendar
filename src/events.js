export default [
    ...
    {
      'title': 'Meeting',
      'start': new Date(2021, 3, 15, 14, 0, 0, 0),
      'end': new Date(2021, 3, 15, 15, 0, 0, 0)
    },
    {
      'title': 'Happy Hour',
      'start': new Date(2021, 3, 15, 17, 0, 0, 0),
      'end': new Date(2021, 3, 15, 17, 30, 0, 0),
      desc: 'Most important meal of the day'
    },
    {
      'title': 'Dinner',
      'start': new Date(2021, 1, 15, 20, 0, 0, 0),
      'end': new Date(2021, 1, 15, 21, 0, 0, 0)
    },
    {
      'title': 'Birthday Party',
      'start': new Date(2021, 1, 16, 7, 0, 0),
      'end': new Date(2021, 1, 16, 10, 30, 0)
    },
    {
